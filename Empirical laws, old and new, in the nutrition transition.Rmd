...
The fit (adjusted R-squared) for Bennett's Law deteriorates when the data are geographically disaggregated (Figure \ref{fig:BennettDisagg}). However, the fit for the fat-carb frontier, which is essentially a corrllary to Bennett's Law, remains quite good across regions (Figure \ref{fig:fatCarbDisagg}). Varying parameter values suggest heterogeneity in local conditions from one region to another. I address the possible reasons behind this heterogeneity farther below.
...
Engel went so far as to conclude that "[t]he proportion of the outgo used for food, other things being equal, is the best measure of the material standard of living of a population" [-@zimmerman1932ernst]. In the early literature that Engel set in motion, numerous authors cast doubt on the validity of his observation across different cultural and socioeconomic contexts. Nonetheless, Engel's Law has emerged, today, as a universal empirical phenomenon. An example is given in Figure \ref{fig:Engel0}.
