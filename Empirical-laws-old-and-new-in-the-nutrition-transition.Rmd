...
In the social sciences, empirical laws, also referred to as "stylized facts", have frequently been interpreted as laws of a binding or deterministic character, leading, for example, to notions of "economic determinism" []. It is thus worthwhile to clarify at the outset that "empirical laws", here, refers to observed historical tendencies, typically lacking a firm theoretical explanation. As Houthakker put it:
...
# Putting Engel's Law and Bennett's Law to use: back of the envelope calculations of future food demand

While a full fledged future food demand study is beyond the scope of this article, it is worth taking a moment to sketch out how the empirical laws examined above can be used to generate back-of-the-envelope calculations of future food demand and future cereal & starchy root demand.
