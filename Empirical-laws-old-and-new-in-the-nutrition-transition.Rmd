...
```{r, fig.show = "hold", fig.width = 5, fig.height=4, fig.align="center", fig.cap="\\label{fig:macronutLaws}(Left) Macronutrient laws, 2017 FBS data. (Right) Slope and y intercept trajectories for the carbohydrate law, 1970-2017. The sample size and model fit (adjusted R-squared) are also indicated for each year.", echo = FALSE}
#===========================================================================
#===========================================================================
...
colnames(df_table)[3:ncol(df_table)] <- c("2050\nPopulation\n(billion)",
                                          "2050\nGDP/capita",
                                          "GDP units",
                                          "Notes",
                                          "2050\nfood demand\n(trillion kcal/day)",
...
table_title <- "A selection of published 2050 world food demand projections"
